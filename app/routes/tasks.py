...
def get_tasks(project_id: int):
    ...
    return task_container.retrieve_tasks_controller.get_tasks(project_id, int(get_jwt_identity()))
...
def get_task(project_id: int, task_id: int):
    task_container = current_app.container.task
    return task_container.retrieve_task_controller.get_task(project_id, task_id, int(get_jwt_identity()))
